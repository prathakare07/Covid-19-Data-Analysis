...
month_wise={"districtid":[],"monthno":[],"cases":[],}
district_key_val=[]
time_id_val=[]
no_of_cases_v=[]
...
month_wise["districtid"]=district_key_val
month_wise["monthno"]=time_id_val
month_wise["cases"]=no_of_cases_v
...
final_frame.sort_values(["districtid","monthno"]).to_csv(r'cases-month.csv',index=False)
